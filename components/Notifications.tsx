  ...
  return (
    <Popover>
      <PopoverTrigger className="relative flex size-10 items-center justify-center rounded-lg">
        ...
        {count > 0 && (
          <>
            <div className="absolute right-2 top-2 z-20 size-2 rounded-full bg-blue-500 animate-ping opacity-75" />
          ...
          <InboxNotificationList>
            ...
            {unreadNotifications.length > 0 && unreadNotifications.map((notification) => (
              <InboxNotification
                ...
                className="bg-dark-200 text-white mt-2 border-none rounded-lg hover:bg-dark-300/50 transition-all animate-in fade-in slide-in-from-bottom-4 duration-300 ease-in-out shadow-sm"
